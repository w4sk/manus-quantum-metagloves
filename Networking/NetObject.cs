...
namespace Manus.Networking
{
	...
	{
		//[Utility.ReadOnly]
		[Tooltip("This is the unique id that identifies this object during play mode.")]
		public long m_NetID = long.MinValue;
		//[Utility.ReadOnly]
		[Tooltip("This is the unique id that identifies this object's prefab during play mode.")]
		public int m_PrefabID = int.MinValue; //not sure if this number is never used

		//[Utility.ReadOnly]
		[Tooltip("This is the id of the player who controlls this object.")]
		public long m_ControllerID = 0;

		[Tooltip("When the controller disconnects, does this object get destroyed?")]
		public bool destroyOnControllerDisconnected = false;

		List<Sync.BaseSync> m_Syncables = new List<Sync.BaseSync>();

		[Tooltip("This event is called on the system of the player who gains control of it.")]
		public UnityEngine.Events.UnityEvent onGainOwnership;
		[Tooltip("This event is called on the system of the player who loses control of it.")]
