...
namespace Manus.Haptics
{
	...
	{
		private FingerType fingerType = FingerType.Invalid;

		private Dictionary<Collider, CollisionInfo> m_Collisions;

		private Collider[] m_OwnColliders;

		[Tooltip("What objects can trigger the haptics?")]
		public LayerMask layerMask = ~0;

		[Tooltip("How close to the collidable objects must we be to trigger haptics?")]
		[Range(0.1f, 10f)]
		public float collisionRange = .8f;

		/// <summary>
		/// Update collisions and collision information.
		/// </summary>
		private void FixedUpdate()
		{
			if( m_Collisions == null ) return;
		...
		/// </summary>
		/// <returns>the finger type for the current finger</returns>
		...
		/// </summary>
		/// <param name="p_FingerType">Finger type of finger</param>
		public void SetupFinger( FingerType p_FingerType )
		{
		...
		/// <summary>
		/// Filter out own colliders from collision.
		/// </summary>
		/// <param name="p_CurrentCollisions">Array of current collisions</param>
		/// <returns>Array of colliders not from self</returns>
		...
		/// <summary>
		/// Remove nonexistent collisions from collisions.
		/// </summary>
		/// <param name="p_Collisions">Collisions array</param>
		...
		/// <summary>
		/// Fetch collision position.
		/// </summary>
		/// <returns>Collision position</returns>
		...
		/// </summary>
		/// <returns>Finger haptic value</returns>
	...
	public class CollisionInfo
	{
		...
		/// </summary>
		/// <param name="p_Collider">Collider colliding</param>
		/// <param name="p_Finger">Finger haptic colliding with</param>
		...
		/// </summary>
		/// <param name="p_DeltaTime">Time since last update</param>
		...
		/// </summary>
		/// <param name="p_DeltaTime">Time since last update</param>
		/// <returns>Whether collision timed out</returns>
		...
		/// </summary>
		/// <returns>Strength of collision</returns>
		...
		/// <summary>
		/// Get initial strength based upon collision time.
		/// </summary>
		/// <returns>Starting strength</returns>
		...
		///TODO: Fix once interaction system is added
		/// <summary>
		/// Get strength based upon speed of finger movement.
		/// </summary>
		/// <returns>Relative strength</returns>
